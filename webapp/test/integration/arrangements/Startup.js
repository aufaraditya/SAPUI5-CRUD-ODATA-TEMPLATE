sap.ui.define([
	"sap/ui/test/Opa5",
	"aaufar/fioriodatasampleproject/localService/mockserver",
	"sap/ui/model/odata/v2/ODataModel"
], function(Opa5, mockserver, ODataModel) {
	"use strict";

	return Opa5.extend("aaufar.fioriodatasampleproject.test.integration.arrangements.Startup", {
		...
		iStartMyApp : function (oOptionsParameter) {
			...
			this.iStartMyUIComponent({
				componentConfig: {
					name: "aaufar.fioriodatasampleproject",
					async: true
				},
				hash: oOptions.hash,
