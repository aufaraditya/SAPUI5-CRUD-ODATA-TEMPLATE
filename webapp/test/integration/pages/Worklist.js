sap.ui.define([
		...
		"AAUFARNameSpace/ZFORM_ODATA_AUFAR/test/integration/pages/shareOptions"
			...
			onTheWorklistPage : {
						...
						return this.waitFor(createWaitForItemAtPosition({
							...
							success : function (oTableItem) {
								...
								this.getContext().currentItem = {
									...
									id: oBindingContext.getProperty("Persno"),
									name: oBindingContext.getProperty("Persno")
								};
							}
						}));
					},
				...
				assertions: jQuery.extend({
					...
					theTableShouldHaveAllEntries : function () {
						...
						// retrieve all EmpVacDataSet to be able to check for the total amount
