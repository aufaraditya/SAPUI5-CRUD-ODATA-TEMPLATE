		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Odata Sample Project",
									"targetURL": "#aaufarfioriodatasampleproject-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"aaufarfioriodatasampleproject-display": {
								"semanticObject": "aaufarfioriodatasampleproject",
								"action": "display",
								"description": "A Fiori application with Odata from Abyor 2020",
								"title": "Odata Sample Project",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=aaufar.fioriodatasampleproject",
									"url": sap.ui.require.toUrl("aaufar/fioriodatasampleproject")
								}
							}
						}
					}
