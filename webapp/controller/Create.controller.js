...
sap.ui.define([
	...
	return BaseController.extend("aaufar.fioriodatasampleproject.controller.Create", {
		...
		_getDialogSearchHelpGolDar: function() {
			if (this.dialogSearchHelpGolDar) {
				...
				this.dialogSearchHelpGolDar = sap.ui.xmlfragment("aaufar.fioriodatasampleproject.fragment.bloodType", this);
		...
		_getDialogSearchHelp1: function() {
			if (this.dialogSearchHelp1) {
				...
				this.dialogSearchHelp1 = sap.ui.xmlfragment("aaufar.fioriodatasampleproject.fragment.location1", this);
		...
		_getDialogSearchHelp2: function() {
			if (this.dialogSearchHelp2) {
				...
				this.dialogSearchHelp2 = sap.ui.xmlfragment("aaufar.fioriodatasampleproject.fragment.location2", this);
